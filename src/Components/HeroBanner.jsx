...
const HeroBanner = () => {
  return (
    <div className=' mt-20 xl:mt-24 flex w-11/12 mx-auto bg-slate-200 dark:bg-slate-800 rounded-xl'>
      <div className=' flex lg:ml-4 xl:ml-8 flex-1'>
        ...
        <div className=' flex my-4 sm:my-6'>
          <h1 className='font-bold my-auto hidden md:block sm:text-base xl:text-2xl xl:mr-10 lg:text-xl lg:mr-6 md:mr-5 mr-2 text-xs dark:text-white text-black hover:underline cursor-pointer hover:translate-x-3 hover:transition-all '>
            Get Started &#8594;
          </h1>
